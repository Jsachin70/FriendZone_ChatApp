...
public class Validation {
    ...
    public boolean validationRegister(EditText firstname,EditText lastname,EditText address,EditText email,EditText phone,EditText password,EditText repassword) {
